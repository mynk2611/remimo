...
export function FeatureSectionThree() {
  return (
    <LampContainer>
      ...
      >
        <div className='grid grid-cols-2 pt-20 pb-20 bg-gradient-to-b  relative'>
          <div className='flex justify-center items-center'>
                <Coin/>
          </div>

          <div className='flex flex-col justify-center w-9/12 relative'>
                <div className='text-xl sm:text-5xl text-white font-extrabold sm:font-bold'>
                    Get ready for exciting new feature on Remimo!
                </div>

                <div className='text-sm sm:text-lg text-white font- pt-5'>
